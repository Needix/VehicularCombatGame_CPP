...
AVehicleCombatGameCPPHud::AVehicleCombatGameCPPHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AVehicleCombatGameCPPHud::DrawHUD()
{
	Super::DrawHUD();
...
//		AVehicleCombatGameCPPPawn* Vehicle = Cast<AVehicleCombatGameCPPPawn>(GetOwningPawn());
