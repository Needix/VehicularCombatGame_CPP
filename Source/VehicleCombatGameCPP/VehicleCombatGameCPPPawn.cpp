...
const FName AVehicleCombatGameCPPPawn::LookUpBinding("LookUp");
const FName AVehicleCombatGameCPPPawn::LookRightBinding("LookRight");
const FName AVehicleCombatGameCPPPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

AVehicleCombatGameCPPPawn::AVehicleCombatGameCPPPawn()
{
	// Car mesh
...
void AVehicleCombatGameCPPPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AVehicleCombatGameCPPPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AVehicleCombatGameCPPPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AVehicleCombatGameCPPPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AVehicleCombatGameCPPPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AVehicleCombatGameCPPPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AVehicleCombatGameCPPPawn::OnResetVR); 
}

void AVehicleCombatGameCPPPawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void AVehicleCombatGameCPPPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AVehicleCombatGameCPPPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AVehicleCombatGameCPPPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AVehicleCombatGameCPPPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AVehicleCombatGameCPPPawn::EnableIncarView(const bool bState)
{
...
void AVehicleCombatGameCPPPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AVehicleCombatGameCPPPawn::BeginPlay()
{
	Super::BeginPlay();
...
void AVehicleCombatGameCPPPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void AVehicleCombatGameCPPPawn::UpdateHUDStrings()
{
...
void AVehicleCombatGameCPPPawn::SetupInCarHUD()
{
...
void AVehicleCombatGameCPPPawn::UpdatePhysicsMaterial()
{
